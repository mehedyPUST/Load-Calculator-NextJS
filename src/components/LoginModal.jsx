  ...
  return (
    ...
    >
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
        <div className="px-5 pt-5 pb-2 bg-gradient-to-r from-emerald-700 to-teal-800 text-white">
          <h3 className="text-base font-black tracking-tight">Admin Login</h3>
        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 space-y-3">
          ...
          <div>
            ...
            <input
              ...
              disabled={busy}
              className="w-full h-10 px-3 rounded-xl border border-slate-200 text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500"
              placeholder="admin"
            />
          </div>
